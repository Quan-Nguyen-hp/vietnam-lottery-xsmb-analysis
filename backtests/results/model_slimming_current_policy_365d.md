...
### Models ứng viên loại: **['poisson_estimator', 'loto_repeat', 'inverted_pairs', 'max_delay', 'bayesian_predictor']**

### Models đề xuất giữ: **['frequency_momentum', 'markov_chain', 'ewma_probability', 'day_of_week', 'lightgbm_classifier', 'conditional_probability']**
...
### Pruned-fixed (6 models, same exposure)
...
|---|---:|
| ΔROI quan sát | +4.40% |
| Bootstrap CI95 của ΔROI | [-25.13%, +33.22%] |
| P(ΔROI>0) | 59.9% |
...
- Pruned (tự do) cược 3/365 ngày = 0.01 bets/ngày
- Pruned-fixed (cùng exposure) cược 250/365 ngày
- Bỏ ứng viên `max_delay, poisson_estimator, loto_repeat, inverted_pairs, bayesian_predictor` làm fusion probability spread khác → confidence/probability thresholds cho qua nhiều hơn → số bets tăng -247 lượt.
