...
| Chỉ số | Giá trị |
|---|---:|
| PnL quan sát | -153,000đ |
| PnL hoán vị trung bình | +202,351đ |
| PnL hoán vị 95% | [-846,000đ, +1,332,000đ] |
| p-value một phía | 0.7630 |

## 4. Ablation leaderboard cùng mức exposure

| Model | Lượt cược | ROI | ROI bootstrap 95% |
|---|---:|---:|---:|
| bayesian_predictor | 112 | +24.40% | [-14.11%, +66.39%] |
| frequency_momentum | 112 | +17.86% | [-23.00%, +61.76%] |
| inverted_pairs | 112 | +11.31% | [-24.02%, +50.53%] |
| lightgbm_classifier | 112 | +4.76% | [-29.86%, +43.48%] |
| max_delay | 112 | +1.49% | [-30.16%, +35.09%] |
| conditional_probability | 112 | +1.49% | [-33.93%, +39.20%] |
| poisson_estimator | 112 | +1.49% | [-30.33%, +34.91%] |
| day_of_week | 112 | +1.49% | [-31.86%, +37.07%] |
| markov_chain | 112 | -5.06% | [-38.89%, +32.70%] |
| loto_repeat | 112 | -5.06% | [-38.89%, +32.70%] |
| ewma_probability | 112 | -5.06% | [-39.45%, +32.31%] |
