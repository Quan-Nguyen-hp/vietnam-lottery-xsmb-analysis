...
- **Thời gian chạy**: 157.3s
- **Ablation**: Kelly chọn cược = Không; diversification = Bật; calibration toàn bộ models = Tắt
...
| Bets giả lập | 1460 |
| Hits | 374 |
| Hits trung bình/ngày | 1.0247 |
| ROI ranking-only | -6.07% |
| Bootstrap CI95 | [-15.11%, +3.22%] |
| P(ROI>0) | 9.3% |
