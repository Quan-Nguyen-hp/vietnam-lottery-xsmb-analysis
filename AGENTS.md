...
This project is indexed by GitNexus as **vietnam-lottery-xsmb-analysis** (1688 symbols, 2820 relationships, 58 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/vietnam-lottery-xsmb-analysis/context` | Codebase overview, check index freshness |
| `gitnexus://repo/vietnam-lottery-xsmb-analysis/clusters` | All functional areas |
| `gitnexus://repo/vietnam-lottery-xsmb-analysis/processes` | All execution flows |
| `gitnexus://repo/vietnam-lottery-xsmb-analysis/process/{name}` | Step-by-step execution trace |
